...
const UserService = require('./userService'); //Se importa para posibles validaciones adicionales
...
const AuthService = {
    ...
    async loginUser(credentials) {
        ...
        // 1. Buscar usuario por email (Usamos el modulo que ya creamos)
...
// Aquí el servicio orquesta: valida regla de negocio (email único), seguridad (hash de clave) y llama al modelo.