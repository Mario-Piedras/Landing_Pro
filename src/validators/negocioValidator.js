...
// Schema para validar redes sociales (ojeto JSON)
...
exports.createNegocioSchema = z.object({
    razon_social: z.string().min(3, 'La razon social debe tener al menos 3 caracteres'),
...
exports.updateNegocioSchema = z.object({
    razon_social: z.string().min(3, 'La razon social debe tener al menos 3 caracteres').optional(),
    logo_url: z.string().optional(),
    descripcion: z.string().optional(),
    telefono: z.string().max(20).optional(),
    email: z.string().email('Formato de email invalido').optional(),
